...
//----------------------------------------------------------------------
bool computeMedianDark(const std::vector<std::string> & vecImPath, const std::string & format, astroT::Image & finalIm)
{
    /*
...
//----------------------------------------------------------------------
bool computeMeanDark(const std::vector<std::string> & vecImPath, const std::string & format, astroT::Image & finalIm)
{

    //---- Ouverture de la premiere image
    astroT::Image firstIm;
